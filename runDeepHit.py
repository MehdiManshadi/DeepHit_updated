...
# ==================================================
path = (
    "/Users/mehman/Projects/0_Reference_Data/0_otherRegions/Processed/Region_Sthlm_Gotland_model_data_binary_ALL_Included.csv"
)
    ...
    for t, t_time in enumerate(eval_time):
        ...
        if eval_horizon >= num_Category:
            ...
            for k in range(num_Event):
                ...
                #result.loc[k+1, feat, perm_iter, "Delta t = " + "{:03d}".format(t_time)] = result1[k,t] - resultfeat[k,t]
                # since we compare risk_scores, the true label is that event occurs before time horizon
    print(f"C-index at eval time for {Region_names[i]}:", resultfeat)
